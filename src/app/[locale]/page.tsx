                ...
                {[
                  {
                    ...
                    value: isAr ? 'ياسمين 6، التجمع الخامس، القاهرة، مصر' : 'Yasmin 6, New Cairo, Cairo, Egypt',
                    icon: (
                  ...
                  <div key={label} className={`flex items-start gap-4 ${isAr ? 'rtl:flex-row-reverse' : ''}`}>
                    ...
                    <div>
                      ...
                      <p className="text-ink/80 text-sm leading-relaxed">{value}</p>
                    </div>
                  </div>
                ))}
              </div>
