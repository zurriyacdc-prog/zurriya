...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    approach: {
      en: 'At the core of Ziad\'s practice is Applied Behavior Analysis (ABA) — not as a rigid protocol, but as a framework for understanding why a child does what they do and what conditions will support lasting, generalized change. His starting point is always function: before any intervention is designed, he identifies what drives a behavior — the environmental, developmental, and relational variables maintaining it — and builds the plan around that understanding rather than around the label.\n\nWithin that framework, Ziad integrates Functional Communication Training (FCT), Discrete Trial Training (DTT), and function-based behavior intervention alongside Cognitive Behavioral Therapy (CBT) and Acceptance and Commitment Therapy (ACT), selecting and combining methods based on each child\'s individual profile. Everything he does is data-driven: intervention plans are built on systematic assessment, tracked through ongoing data collection, and adjusted in real time based on what the data shows. And throughout, parents, teachers, and support staff are brought in as active participants from the outset — because progress achieved only inside a session is progress that doesn\'t hold.',
      ar: 'تحليل السلوك التطبيقي (ABA) هو المحور الذي تقوم عليه ممارسة زياد — لا بوصفه بروتوكولاً جامداً، بل إطاراً لفهم سبب السلوك ولتحديد الشروط التي تُتيح تغييراً حقيقياً وقابلاً للتعميم. نقطة انطلاقه دائماً الوظيفة: قبل أي تدخل، يُحدّد ما الذي يُغذّي السلوك — المتغيرات البيئية والنمائية والعلائقية المحافظة عليه — ثم يبني الخطة انطلاقاً من هذا الفهم لا من التشخيص وحده.\n\nضمن هذا الإطار، يدمج زياد التدريب على التواصل الوظيفي (FCT) والتدريب بالمحاولات المنفصلة (DTT) والتدخل السلوكي الوظيفي، إلى جانب العلاج المعرفي السلوكي (CBT) وعلاج القبول والالتزام (ACT) — مختاراً الأساليب ومركّبها وفق الملف الفردي لكل طفل. كل ما يقوم به مبني على البيانات: خطط التدخل مبنية على تقييم منهجي، ومتابَعة بجمع منتظم للبيانات، ومُعدَّلة في الوقت الفعلي وفق ما تُظهره. وعلى مدار العملية، يُشرَك الأهل والمعلمون وفرق الدعم شركاء فاعلين منذ البداية — لأن التقدم الذي يحدث داخل الجلسة فقط لا يُحتسب.',
    },
    experience: {
